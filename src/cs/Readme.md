...
#### [&uarr;](#3_s)  <a name="3_2"> Инициализаторы объектов</a>
...
#### [&uarr;](#3_s)  <a name="3_11"> Константы и поля для чтения (const, readonly)</a>
* Константы : (***const***)
...
#### [&uarr;](#3_s)  <a name="3_16"> Ключевое слово ***base***</a>
...
#### [&uarr;](#3_s)  <a name="3_22"> Абстрактные члены классов</a>
...
#### [&uarr;](#3_s)  <a name="3_24"> Обобщения .NET v2.0 (`className<T>`)</a>
...
##### [&uarr;](#3_s)  <a name="3_24_3"> Использование нескольких универсальных параметров</a>
```php
...
##### [&uarr;](#3_s)  <a name="3_26_1">Сочетание своих обобщенных параметров и базового класса</a>
```php
...
* ***Исключения*** - ситуации когда возникают трудно отслеживаемые ошибки
* Для обработки ***исключений*** предназначена конструкция ***try...catch***
* При наличии конструкции можно избежать аварийного завершения программы и обработать ошибку
```php
try {
  ...
} catch (Exception ex) {
...
```
* Сначала выполняется блок ***try*** затем
  * Если возникло исключение :
    * Запускается блок ***catch***
    * Затем блок ***finally***
  * Если всё хорошо :
    * После блока ***try*** запускается блок ***finally***
* Блоков ***catch*** может быть несколько под разные исключения
* Выполнение блоков ***catch*** начинается от частных случаев к более общим
* С точки зрения производительности ***try...catch*** лучше заменять на условную конструкцию
...
##### [&uarr;](#4_s)  <a name="4_2_1">Фильтры исключений</a>
...
#### [&uarr;](#4_s)  <a name="4_2">Типы исключений. Класс Exception</a>
