...
#### Константы и поля для чтения (const, readonly)
* Константы : (***const***)
...
#### Виртуальные методы и свойства (***virtual***)
...
* При переопределении также объявляется с модификатором ***override***
* Если есть абстрактный элемент, сам класс тоже должен быть с модификатором ***override***
...
#### Обобщения .NET v2.0 (generics)
* Обобщенные типы `className<T>`
