...
* <a name="3_s">[Классы (ООП)](#3)</a>
  ...
  * [Виртуальные методы и свойства (***virtual***)](#3_19)
...
#### [&uarr;](#3_s)  <a name="3_19"> Виртуальные методы и свойства (***virtual***)</a>
* Это методы и свойства, которые нужно переопределять при наследовании
