...
### Массивы [Примеры](https://metanit.com/sharp/tutorial/pics/array.png)
...
#### 2) Простой перебор двумерного массива
```c#
...
#### 3) Перебор двумерного массива по каждой строке таблицы
...
#### 4) Массив массивов (зубчатый массив)
...
#### 1) Использование кортежей в функциях
